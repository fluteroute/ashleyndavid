...
import { Image, Link, ListBox, ListBoxItem, NavigationLink, Paragraph } from '../components';
    ...
    <>
      ...
      >
        ...
        <Paragraph>
          ...
          into the tech industry quickly, I secured a QA internship and changed my major to
          {" Psychology, enabling me to complete my bachelor's degree on time. As I gained more "}
          experience in QA, I recognized the future potential of automation. With determination, I
          taught myself Python and computer science basics, subsequently using my newfound skills to
          script automated tests with Selenium WebDriver as a full-time QA Analyst. Collaborating
          closely with software engineers, I absorbed valuable coding expertise and decided to
          change my career path once more. As a software engineer, I have created design systems,
          web applications, and automated test frameworks. Now, with experience in several
          programming languages, I am passionate about providing end-to-end full-stack solutions.
          Please visit the <NavigationLink to="/career">Career</NavigationLink> page for more in
      ...
      <Paragraph>
        ...
        <NavigationLink as={RouterLink} to="/contact">
          Contact
        </NavigationLink>{' '}
        pages.
      </Paragraph>
