    ...
    <>
      ...
      >
        ...
        <Paragraph>
          ...
          coding expertise and decided to change my career path once more. As a software engineer, I
          have created design systems, web applications, and automated test frameworks. Now, with
          experience in several programming languages, I am passionate about providing end-to-end
